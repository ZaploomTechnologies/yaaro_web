...
export const FEATURES = [
  {
    ...
    description: 'Post workouts, photos and milestones. Like, comment and cheer friends on, and discover trending fitness content.',
    badge: 'Social',
  ...
  },
  {
    ...
    description: 'Earn points on every activity. Redeem for real fitness gear and vouchers, with bonus points for streaks and challenges.',
    badge: 'Rewards',
  ...
  },
  {
    ...
    subtitle: 'Challenges',
    description: 'Join weekly and monthly community challenges. Climb leaderboards, win rewards, and create private challenges with friends.',
    badge: 'Challenges',
  ...
  },
  {
    ...
    description: 'Browse and join clubs by sport or interest. Plan group runs, rides and workouts, and stay active and connected.',
    badge: 'Clubs',
